                ...
                <form action="/app/plan/edit" method="post">
                    ...
                    <div class="schedules-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input name="name" class="form-control" value="${plan.name}" id="planName"
                                       placeholder="Nazwa planu" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="description" class="form-control" rows="5" id="planDescription"
                                          placeholder="Opis planu" required>${plan.description}</textarea>
                            </div>
                        </div>
