            ...
            <div class="container w-25">
                ...
                <form class="padding-small text-center" action="register" method="post">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="name" name="firstName" placeholder="podaj imię" required>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" id="surname" name="lastName" placeholder="podaj nazwisko" required>
                    </div>
                    <div class="form-group">
